...
namespace TemperatureMonitor.Services
{
    ...
    /// </summary>
    public static class TemperatureLogReader
    {
        public static async Task<List<DataPoint>> ReadTemperatureLogFileAsync(string filePath, CancellationToken cancellationToken = default)
        {
